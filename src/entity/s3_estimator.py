...
class Proj1Estimator:
    ...
    def __init__(self,bucket_name,model_path,):
        ...
        self.loaded_model:MyModel=None #type: ignore
    ...
    def load_model(self,)->MyModel:
        ...
        return self.s3.load_model(self.model_path,bucket_name=self.bucket_name)  #type: ignore
