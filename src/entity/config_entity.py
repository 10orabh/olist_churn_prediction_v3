...
class DataTransForamationConfig:
    ...
    transformed_train_file_name:str = os.path.join(data_trainsformation_dir,DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,TRAIN_FILE_NAME.replace('csv','npy'))
    transformed_test_file_name:str = os.path.join(data_trainsformation_dir,DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,TEST_FILE_NAME.replace('csv','npy'))
